      ...
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
          ...
          <h1 className='py-4 text-gray-700'>
            Hi, I&#39;m <span className='text-[#5651e5]'> Vikas</span>
          </h1>
          <h1 className='py-2 text-gray-700'>A Full-Stack Developer</h1>
          <p className='py-4 text-gray-600 sm:max-w-[70%] m-auto'>
            Experienced full stack developer proficient in building responsive web applications.
            Expertise in front-end frameworks, back-end technologies, and database management.
          </p>
